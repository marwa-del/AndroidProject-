...
public class Registeractivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_login.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent loginIntent =new Intent(Registeractivity.this,LogInscreen.class);
        ...
        Register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Creating SQLite database ken mouch mawjouda
                SQLiteDataBaseBuild();
    ...
    public void InsertDataIntoSQLiteDatabase(){
        ...
        if(EditTextEmptyHolder == true)
        {
            ...
            Toast.makeText(Registeractivity.this,"Utilisateur ajouté avec Succes", Toast.LENGTH_LONG).show();
        ...
        // This block will execute if any of the registration EditText is empty.
            ...
            Toast.makeText(Registeractivity.this,"Remplir tous les champs!", Toast.LENGTH_LONG).show();
    ...
    public void CheckFinalResult(){
        ...
        if(F_Result.equalsIgnoreCase("Email Found"))
        {
            ...
            Toast.makeText(Registeractivity.this,"Email Exist deja",Toast.LENGTH_LONG).show();
